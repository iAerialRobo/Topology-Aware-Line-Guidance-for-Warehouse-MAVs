...
def plot_position_data(x_positions, y_positions):
    ...
    # 绘制无人机飞行轨迹（深紫色，细线，虚线）
    plt.plot(x_positions, y_positions, color=(128/255, 0, 128/255), linewidth=20, linestyle='-')

    # 绘制参考线（深紫色，粗线，实线）
    plt.plot([0.006, 0.186, 0.186], [0.006, 0.006, 0.074], color=(105 / 255, 105 / 255, 105 / 255), linewidth=10, linestyle='--')
